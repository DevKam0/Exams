...
<body>
    ...
    <main>
        ...
        <?php
            $result = mysqli_query($conn, query: "SELECT DISTINCT s.data_ur, s.miot, r.rasa FROM swinki s INNER JOIN rasy r ON s.rasy_id = r.id WHERE r.id = 7;");
        ...
        <?php
            $result = mysqli_query($conn, query: "SELECT imie, cena, opis FROM swinki WHERE rasy_id = 7;");
